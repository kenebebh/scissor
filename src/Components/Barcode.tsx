  ...
  function Barcode() {
    ...
    return (
      ...
      <div className="flex flex-col items-center box-border h-90 w-100 p-4   m8 box-content" id="barcode" data-testid="barcode-1">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 6.75h.75v.75h-.75v-.75zM6.75 16.5h.75v.75h-.75v-.75zM16.5 6.75h.75v.75h-.75v-.75zM13.5 13.5h.75v.75h-.75v-.75zM13.5 19.5h.75v.75h-.75v-.75zM19.5 13.5h.75v.75h-.75v-.75zM19.5 19.5h.75v.75h-.75v-.75zM16.5 16.5h.75v.75h-.75v-.75z" />
        ...
        <h1 className="mb-4  pb-4 text-6xl leading-tight font-bold text-white">QRCode Generator</h1>
        <QRCode value={text} />

      <div data-testid="barcode-2">
        <br />
        <p className="font-medium">Enter the copied link to get your Barcode</p>
      
          <input type="text" name="email" onChange={(e) => {handleChange(e)}}  className="mt-1 px-2 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Enter the copied link to get your Barcode" />
