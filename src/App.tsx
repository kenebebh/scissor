  ...
  return (
    <div className="kene w-full h-full">
      ...
      <section className=" flex justify-center first-line:flex-col items-center">
        <div className="h-90 w-auto p-4 border-4 bg-white-400 m8 box-content">
          <Pricing />
        </div>
      </section>
      ...
      <section
        id="urlshort"
        className=" items-center h-screen flex justify-center bg-sky-300 via-slate-500 to-slate-600"
      >
        <div className="h-90 w-auto p-4 border-4 bg-white-400 m8 box-content">
          <UrlShortner />
        </div>
      ...
      <section className="bg-cyan-400" id="barcode">
        <div className="h-90 w-auto p-4 border-3 bg-white-400 m8 box-content">
          <Barcode />
        </div>
      </section>
      ...
      <footer className="h-90 w-auto p-4 border-3 bg-white-400 m8 box-content bg-green-300">
        <section className="h-90 w-auto p-4 border-3 bg-white-400 m8 box-content bg-amber-800">
          <div className="w-auto relative bg-white box-content m8 border-3">
            <div className="justify-start items-start gap-6 inline-flex">
              <div className="flex-col justify-start items-start gap-14 inline-flex">
                <div className="px-6 flex-col justify-start items-start gap-2 flex">
                  <div className="text-slate-900 text-[16px] font-bold leading-normal">
                    Why Scissor ?
                  </div>
                  <div className="justify-start items-start inline-flex">
                    <div className="text-slate-900 text-[16px] font-normal leading-normal">
                      Scissor 101
                      <br />
                      Integrations & API
                      <br />
              ...
              <div className="px-6 flex-col justify-start items-start gap-2 inline-flex">
                <div className="w-[94px] h-5 text-slate-900 text-[16px] font-bold leading-normal">
                  Company
                </div>
                <div className="justify-start items-start inline-flex">
                  <div className="text-slate-900 text-[16px] font-normal leading-normal">
            ...
            <div className="left-[203px] top-[95px] absolute flex-col justify-start items-start gap-8 inline-flex">
              <div className="p-2 justify-start items-start gap-2 inline-flex">
                ...
                <div className="w-[90px] h-6 text-neutral-900 text-[22px]  mb-4 font-bold leading-loose">
                  SCISSOR
                </div>
              </div>
            ...
            <div className="px-3 justify-center items-center gap-2 inline-flex">
              <div className="text-slate-900 text-[14px] font-normal leading-tight">
                Term of Service
              </div>
              <div className="text-slate-900 text-[14px] font-normal leading-tight">
                Security
